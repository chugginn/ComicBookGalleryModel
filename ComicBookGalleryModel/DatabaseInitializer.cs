...
{
    // internal allows this class to be used only by other classes in the same project/assembly
    internal class DatabaseInitializer : DropCreateDatabaseIfModelChanges<Context>
    {
        // we will override the Seed method given by DropCreateDatabaseIfModelChanges to seed our database
